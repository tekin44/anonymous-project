				...
				<form action="<?=$action?>" method="post">
					<table border="0" cellpadding="0" cellspacing="0"  id="id-form" width="100%">
						<tr>
							...
							<td><input name="nomor_induk_staff" type="text" class="inp-form" /></td>
							<th valign="top">Nama:</th>
							<td><input name="nama_staff" type="text" class="inp-form" /></td>
...
?>
				...
				<tr class="alternate-row">
					<td><? echo ++$i; ?></td>
					<td><? echo $item->nomor_induk_staff ?></td>
					<td><? echo $item->nama_staff ?></td>
