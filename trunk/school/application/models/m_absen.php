...
class m_absen extends CI_Model {
	...
	public function displayAbsen($tanggal) {
		$this->load->database();
		$query = $this->db->query("select b.tanggal_absensi, b.no_absensi, a.no_induk, a.nama_person, d.waktu_absen as waktu_masuk, c.waktu_absen as waktu_keluar  
	...
	public function updateAbsensi($no_induk, $keterangan) {
